...
import { faPlus, faLink, faGlobe, faFile} from '@fortawesome/free-solid-svg-icons';
import { faTwitter, faReddit, faGithub} from '@fortawesome/free-brands-svg-icons';
